...
public class ConfigHandler {
    ...
    public static boolean enableGoSmelt;
    ...
    public static void syncConfig() {
        ...
        enablePortableFurnace = config.getBoolean("enablePortableFurnace", category, true, "Allow portable furnace. Disable if you don't want portable furnace. Requires restart of client.");
        ...
        enableGoSmelt = config.getBoolean("enablePortableFurnace", category, false, "Allow portable furnace. Disable if you don't want portable furnace. Requires restart of client.");
