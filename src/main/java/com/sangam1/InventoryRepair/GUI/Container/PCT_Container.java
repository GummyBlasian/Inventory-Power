...
public class PCT_Container extends Container {
	...
	/*
	 * private int addCraftingSlot(PlayerInventory handler, int index, int x, int y,
	 * int amount, int dx) { for (int i = 0 ; i < amount ; i++) { addSlot(new
	 * CraftingSlot(handler, index, x, y)); x += dx; index++; } return index; }
	 */
