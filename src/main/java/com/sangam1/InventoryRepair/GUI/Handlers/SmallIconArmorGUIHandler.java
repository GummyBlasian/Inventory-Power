...
public class SmallIconArmorGUIHandler {
	...
	public static void headGUI(FontRenderer textRenderer, Minecraft mc, int guiPosX, int guiPosY) {
		if(ArmorDurability.getHead_Icon() != null) {
			...
			mc.getItemRenderer().renderItemAndEffectIntoGUI(ArmorDurability.getHead_Icon(), (int) (guiPosX - (txtwidth_armor_head_durability * (0.7/0.5)) - 15), guiPosY);
		}
	}
	...
	public static void bodyGUI(FontRenderer textRenderer, Minecraft mc, int guiPosX, int guiPosY) {
		if(ArmorDurability.getBody_Icon() != null) {
			...
			mc.getItemRenderer().renderItemAndEffectIntoGUI(ArmorDurability.getBody_Icon(), (int) (guiPosX - (txtwidth_armor_body_durability * (0.7/0.5)) - 15), guiPosY);
		}
	}
	...
	public static void legGUI(FontRenderer textRenderer, Minecraft mc, int guiPosX, int guiPosY) {
		if(ArmorDurability.getLeg_Icon() != null) {
			...
			mc.getItemRenderer().renderItemAndEffectIntoGUI(ArmorDurability.getLeg_Icon(), (int) (guiPosX - (txtwidth_armor_leg_durability * (0.7/0.5)) - 15), guiPosY);
		}
	}
	...
	public static void bootGUI(FontRenderer textRenderer, Minecraft mc, int guiPosX, int guiPosY) {
		if(ArmorDurability.getBoot_Icon() != null) {
			...
			mc.getItemRenderer().renderItemAndEffectIntoGUI(ArmorDurability.getBoot_Icon(), (int) ((guiPosX - txtwidth_armor_boot_durability * (0.7/0.5)) - 15), guiPosY);
		}
	}
