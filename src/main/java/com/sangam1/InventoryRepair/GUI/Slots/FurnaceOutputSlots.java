...
public class FurnaceOutputSlots extends FurnaceSlots
{
    /** The player that is using the GUI where this slot resides. */
    private final EntityPlayer thePlayer;
    private int removeCount;

    public FurnaceOutputSlots(EntityPlayer player, ItemPortableFurnace itemPortableFurnace, int slotIndex, int xPosition, int yPosition)
    {
